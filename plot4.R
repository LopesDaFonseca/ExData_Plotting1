...
plot(y=EPC.tidy$Global_active_power, x=EPC.tidy$DateTime, type="l", xlab="", ylab="Global Active Power")
...
legend("topright",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=1, col=c("black","blue","red"), bty="n", cex=0.9 )

# Plot Upper Right Corner
plot(y=EPC.tidy$Voltage, x=EPC.tidy$DateTime, type="l", xlab="datetime", ylab="Voltage")

# Plot Lower Right Corner
plot(y=EPC.tidy$Global_reactive_power, x=EPC.tidy$DateTime, type="l", xlab="datetime", ylab="Global_reactive_power")
